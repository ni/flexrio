...
% endif
    ...
    <FlexRIOPortMappingList>
        <source name="AppletonTopTemplate.vhd" >
            ...
            <port names="AuxIoMgtTxLane[index=0..3]_p"> <!-- top level port name -->
                <change_type>RemoveIfUnused</change_type>
                <component_port>DioMgtTX_p(#{index})</component_port>
                <clip_attribute>DIOMgtTx#{index}</clip_attribute>
            </port>
            <port names="AuxIoMgtTxLane[index=0..3]_n"> <!-- top level port name -->
                <change_type>RemoveIfUnused</change_type>
                <component_port>DioMgtTX_n(#{index})</component_port>
                <clip_attribute>DIOMgtTx#{index}</clip_attribute>
            </port>
            
            <port names="AuxIoMgtRxLane[index=0..3]_p"> <!-- top level port name -->
                <change_type>RemoveIfUnused</change_type>
                <component_port>DioMgtRX_p(#{index})</component_port>
                <clip_attribute>DIOMgtRx#{index}</clip_attribute>
            </port>
            <port names="AuxIoMgtRxLane[index=0..3]_n"> <!-- top level port name -->
                <change_type>RemoveIfUnused</change_type>
                <component_port>DioMgtRX_n(#{index})</component_port>
                <clip_attribute>DIOMgtRx#{index}</clip_attribute>
            </port>
